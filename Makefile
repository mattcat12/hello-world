...
CXXFLAGS=$(CFLAGS)
OBJECTS=demo-main.o minimal-example.o c-example.o text-example.o scrolling-text-example.o clock.o ledcat.o input-example.o ChessMatt.o
BINARIES=demo minimal-example c-example text-example scrolling-text-example clock ledcat input-example ChessMatt
